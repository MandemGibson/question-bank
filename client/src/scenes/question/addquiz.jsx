...
function AddQuiz() {
  ...
  const [question, setQuestion] = useState(() => {
    const localValue = localStorage.getItem("quizQuestion");
    if (localValue === null) {
      return "";
    }
  ...
  const [answerChoices, setAnswerChoices] = useState(() => {
    const localValue = localStorage.getItem("quizAnswerChoices");
    if (localValue === null) {
      return ["", "", "", ""];
    }
  ...
  const [image, setImage] = useState(() => {
    const localValue = localStorage.getItem("quizImage");
    if (localValue === null) {
      return null;
    }
  ...
  const [correctAnswer, setCorrectAnswer] = useState(() => {
    const localValue = localStorage.getItem("quizCorrectAnswer");
    if (localValue === null) {
      return "";
    }
  ...
  const [questionList, setQuestionList] = useState(() => {
    const localValue = localStorage.getItem("quizQuestionList");
    if (localValue === null) {
      return [];
    }
  ...
  useEffect(() => {
    localStorage.setItem("quizImage", JSON.stringify(image));
    localStorage.setItem("quizQuestion", JSON.stringify(question));
    localStorage.setItem("quizAnswerChoices", JSON.stringify(answerChoices));
    localStorage.setItem("quizCorrectAnswer", JSON.stringify(correctAnswer));
    localStorage.setItem("quizQuestionList", JSON.stringify(questionList));
  ...
  const handlePostToDB = async (
    ...
    const quizquestionTexts = questionList.map((q) => ({
      question: q.question,
    ...
    try {
      ...
      await axios.post(`${apiUrl}/questions`, {
        title: title,
        classId: levelId,
        categoryId: "40f30331-7f3e-4480-9043-64f30d9b487e",
  ...
  return (
    <Box display="flex" flexDirection="column" padding="20px">
      ...
      <h3 style={{ margin: "0px", marginTop: "0px" }}>Set New Quiz Questions</h3>
      <Box
        display="flex"
        flexDirection="column"
        bgcolor="#fff"
      ...
      >
        ...
        >
          <form onSubmit={handleSubmit}>
            ...
            <Box>
              <label htmlFor="quizquestionText">
            ...
            <Box>
              <label htmlFor="quizCorrectAnswer">
                <p
                  style={{
                    margin: "0px",
                    fontFamily: "Rubik",
